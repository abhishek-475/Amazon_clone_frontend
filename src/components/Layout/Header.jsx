  ...
  return (
    <header className="bg-[#131921] sticky top-0 z-50 text-white">
      <div className="max-w-[1500px] mx-auto flex items-center justify-between px-4 py-2">
        ...
        <Link
          to="/"
          className="flex items-center min-w-[120px] hover:outline hover:outline-1 hover:outline-white rounded-sm p-1"
        >
        ...
        {/* ---------- Delivery Location ---------- */}
        <div className="flex flex-col cursor-pointer px-2 hover:outline hover:outline-1 hover:outline-white rounded-sm p-1">
        ...
        {/* ---------- Search Bar ---------- */}
        <div className="flex items-center flex-1 mx-4 max-w-2xl">
          <div className="flex items-center bg-white rounded-l-md h-10 px-2 border-r border-gray-300">
            <span className="text-gray-600 text-sm">All</span>
            <i className="fas fa-chevron-down text-gray-400 text-xs ml-1"></i>
          </div>
          <input
            type="text"
            className="flex-1 outline-none border-none px-3 text-black text-sm h-10 w-full"
            placeholder="Search Amazon.in"
          />
          <button className="bg-[#febd69] hover:bg-[#f3a847] transition-colors duration-200 w-12 h-10 flex items-center justify-center cursor-pointer rounded-r-md">
            <i className="fas fa-search text-gray-900 text-base"></i>
          </button>
        </div>

        {/* ---------- Language Selector ---------- */}
        <div className="flex items-center cursor-pointer px-2 hover:outline hover:outline-1 hover:outline-white rounded-sm p-1">
          <img 
        ...
        >
          ...
          <span className="text-sm font-semibold text-white mt-4">Cart</span>
        </Link>
      </div>

      {/* ---------- Secondary Navigation ---------- */}
      <div className="bg-[#232f3e] py-1 px-4">
        <div className="max-w-[1500px] mx-auto flex items-center gap-4 text-sm">
